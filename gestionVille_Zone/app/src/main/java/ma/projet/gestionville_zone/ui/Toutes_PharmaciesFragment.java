...
public class Toutes_PharmaciesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_toutes__pharmacies, container, false);

        recyclerView = view.findViewById(R.id.toutePharRecycleview);
        ...
        Call<List<PharmacieVilleZone>> listCall = myApiRetrofit.getPharmacies();
        ...
        listCall.enqueue(new Callback<List<PharmacieVilleZone>>() {
            ...
            public void onResponse(Call<List<PharmacieVilleZone>> call, Response<List<PharmacieVilleZone>> response) {
                ...
                for (i=0; i <data.size(); i++) {
                    ...
                    pharmacieAdapter = new PharmacieAdapter(data , getContext());
